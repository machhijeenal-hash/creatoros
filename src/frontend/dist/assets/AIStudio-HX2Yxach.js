import { c as createLucideIcon, j as reactExports, I as useDirection, J as useControllableState, q as jsxRuntimeExports, P as Primitive, K as useId, R as Root, N as Item, O as composeEventHandlers, Q as createRovingFocusGroupScope, U as createContextScope, V as Presence, W as cn, X as commonjsGlobal, Y as getDefaultExportFromCjs, _ as useGenerations, $ as useCreateGeneration, a0 as useUpdateGenerationSaved, a1 as useUpdateGenerationFavorite, Z as Zap, z as LoaderCircle, S as Sparkles, A as AnimatePresence, t as motion } from "./index-Bt5dTGTg.js";
...
import { L as Label, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-BoDGnUUe.js";
...
const BookmarkCheck = createLucideIcon("bookmark-check", __iconNode$6);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Bookmark = createLucideIcon("bookmark", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function HistoryItem({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      type: "button",
      onClick,
      className: `w-full text-left px-3 py-2.5 rounded-lg border transition-all duration-200 ${active ? "border-primary bg-primary/10 text-foreground" : "border-border bg-card hover:border-primary/40 hover:bg-muted text-foreground"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium truncate text-muted-foreground", children: gen.goal }),
          gen.favorite && /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: "w-3 h-3 shrink-0 text-secondary fill-secondary" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-medium truncate mt-0.5", children: [
          gen.niche,
          " · ",
          gen.platform
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: formatDate(gen.createdAt) })
      ]
    }
  );
}
function OutputPanel({
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-8 h-8 text-primary" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-sm", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-semibold font-display text-foreground mb-2", children: "Start generating" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Fill the form to create your first piece of AI content. Choose your niche, platform, and goal to get started." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2 justify-center", children: SUGGESTIONS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", "data-ocid": "ai_studio.output_panel", children: [
    (generation || displayText) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0 },
        animate: { opacity: 1 },
        ...
        children: [
          isTyping && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Square, { className: "w-3 h-3 fill-current" }),
                "Stop"
              ]
            }
          ),
          !isTyping && !isGenerating && generation && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  copied ? /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-3 h-3 text-primary" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardCopy, { className: "w-3 h-3" }),
                  copied ? "Copied" : "Copy"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  generation.saved ? /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkCheck, { className: "w-3 h-3" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Bookmark, { className: "w-3 h-3" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: isGenerating && !displayText ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full gap-4 py-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-12 h-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                style: {
                  background: "conic-gradient(from 0deg, oklch(0.56 0.22 262), oklch(0.52 0.18 297), oklch(0.56 0.22 262 / 0))"
                }
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-1 rounded-full bg-card" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
        ...
        ] }) : displayText ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { children: displayText }),
...
function AIStudio() {
  ...
  const [activeGen, setActiveGen] = reactExports.useState(null);
  ...
  const filteredHistory = historyFilter === "saved" ? history.filter((g) => g.saved) : history;
  const startTypewriter = reactExports.useCallback((text2, gen) => {
  ...
  const isFormValid = form.niche.trim() && form.platform && form.audience.trim() && form.tone && form.goal;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col", "data-ocid": "ai_studio.page", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(WandSparkles, { className: "w-4 h-4 text-primary" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-bold font-display text-foreground leading-none", children: "AI Studio" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Generate content with AI" })
        ] })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-hidden flex flex-col lg:flex-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 border-b border-border", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground mb-4", children: "Generation Settings" }),
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          SelectTrigger,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select platform" })
                          }
                        ),
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          SelectTrigger,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select tone" })
                          }
                        ),
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          SelectTrigger,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select goal" })
                          }
                        ),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Button,
                    {
                      ...
                      style: createGen.isPending ? {
                        backgroundImage: "linear-gradient(90deg, oklch(0.56 0.22 262), oklch(0.52 0.18 297), oklch(0.56 0.22 262))",
                        backgroundSize: "200% 100%",
                        animation: "shimmer 1.5s linear infinite"
                      } : void 0,
                      children: [
                        createGen.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4 h-4" }),
                        createGen.isPending ? "Generating…" : "Generate Content"
                      ]
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mt-3", children: SUGGESTIONS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "button",
                    {
                      type: "button",
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-sm font-semibold text-foreground", children: "History" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: filteredHistory.length })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Tabs,
                    {
                      value: historyFilter,
                      onValueChange: (v) => setHistoryFilter(v),
                      className: "mb-3",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto space-y-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { initial: false, children: filteredHistory.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.div,
                    {
                      initial: { opacity: 0 },
                      animate: { opacity: 1 },
                      ...
                      children: historyFilter === "saved" ? "No saved generations yet" : "No generations yet"
                    },
                    "empty"
                  ) : filteredHistory.map((gen, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    motion.div,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                        ...
                        {
                          gen,
                          active: (activeGen == null ? void 0 : activeGen.id) === gen.id,
